    ...
    <li className="col-span-1 flex flex-col text-center bg-white rounded-lg shadow divide-y divide-gray-200">
      <div className="flex-1 flex flex-col">
        ...
        <dl className="mt-1 flex-grow flex flex-col justify-between px-4 pb-4">
          {props.children}
          <dd className="mt-3 space-x-2 flex flex-wrap justify-center">
            {props.stack.map((v) => (
              <span
                key={v}
        ...
        <div className="-mt-px flex divide-x divide-gray-200">
          <div className="w-0 flex-1 flex">
            <a
              ...
              } relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-2 text-sm font-medium border border-transparent rounded-bl-lg`}
              rel="noreferrer"
            >
              <svg
                className="h-6 w-6"
